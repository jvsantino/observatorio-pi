...
export default function Home() {
  ...
  return (
    <div className="min-h-screen md:h-screen flex flex-col md:overflow-hidden" style={{ background: '#f0f4f8' }}>
      ...
      <div style={{ background: '#004A8C' }} className="flex-1 flex flex-col items-center justify-center text-center px-6 py-6">
        ...
        <p style={{ color: '#B8D4F0' }} className="text-sm md:text-base lg:text-lg max-w-2xl mb-6">
